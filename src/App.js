...
import CoordinatorCreateTaskPage from "./components/Coordinator/CreateTaskPage";
import CoordinatorWaitingBin from "./components/Coordinator/WaitingBinPage";
        ...
        <>
            <div className="container">
                <Routes>
                    ...
                    <Route path= "/CoordinatorCreateTaskPage" element={<CoordinatorCreateTaskPage />} />
                    <Route path= "/CoordinatorWaitingBin" element={<CoordinatorWaitingBin />} />
                </Routes>
            </div>
        </>
    )
