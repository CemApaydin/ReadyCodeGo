    ...
    return (
        <nav className="opNav">
            <ul>
                ...
                <CustomLink to="/StudentApplicationsPage">Applications</CustomLink>
                <CustomLink to="/StudentChangeApplicationPage">Change Application</CustomLink>
                <CustomLink to="/StudentUploadTaskPage">Upload Task</CustomLink>
                <CustomLink to="/StudentTaskListPage">TaskList</CustomLink>
            </ul>
        </nav>
